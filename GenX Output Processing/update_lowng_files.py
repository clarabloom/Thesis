...
SCENARIO_ROOT = Path(
    "/scratch/gpfs/JENKINS/cb2158/GenX.jl-main/example_systems/FINAL_SYSTEMS/futures_scenarios/lowng"
)

# IMPORTANT: point directly to the files you manually verified
SOURCE_FILES = {
    "inputs_p1": Path("/scratch/gpfs/JENKINS/cb2158/GenX.jl-main/example_systems/FINAL_SYSTEMS/futures_scenarios/lowng/Fuels_lowng_p1.csv"),
    "inputs_p2": Path("/scratch/gpfs/JENKINS/cb2158/GenX.jl-main/example_systems/FINAL_SYSTEMS/futures_scenarios/lowng/Fuels_lowng_p2.csv"),
    "inputs_p3": Path("/scratch/gpfs/JENKINS/cb2158/GenX.jl-main/example_systems/FINAL_SYSTEMS/futures_scenarios/lowng/Fuels_lowng_p3.csv"),
}
